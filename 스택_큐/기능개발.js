function solution(progresses = [], speeds = []) {
  ...
  // 뒤에 있는 기능은 앞에 있는 기능이 배포될 때 배포됨

  // progresses: 배포되어야하는 순서대로 작업의 진도가 적힌 정수 배열 (% 임 )
  // speeds: 각 작업의 개발 속도가 적힌 정수 배열( % 임 )
  ...
  while (progresses.length > 0) {
    ...
    if (progresses[0] >= 100) {
      // 100넘은 작업들을 앞에서부터 채워줌
      while (progresses[0] >= 100) {
        queue.push(progresses.shift());
        speeds.shift();
      }
      answer.push(queue.length); // 배포된 개수
